    ...
    <div className="w-full bg-white rounded-xl p-6 border border-slate-200/60 shadow-sm flex flex-col justify-center min-h-[160px] space-y-6">
      ...
      <div className="flex items-center gap-6 w-full">
        ...
        <Button
          ...
          variant="outline"
          onClick={reset}
          className="h-8 w-8 rounded-full border-slate-200 text-slate-500 hover:text-primary hover:border-primary transition-all active:scale-95"
        >
        ...
        <div className="flex items-center">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="sm" className="h-8 px-4 text-[11px] font-bold tracking-tight rounded-lg border-slate-200 bg-white hover:bg-slate-50">
                {playbackSpeed}x
              </Button>
            </DropdownMenuTrigger>
